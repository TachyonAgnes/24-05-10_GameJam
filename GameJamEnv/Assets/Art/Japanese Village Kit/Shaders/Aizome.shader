...
Shader "Japanese/Aizome"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Normal_ST;
			float4 _Mask_ST;
			float2 _Sign1position;
			float2 _Sign2position;
			float2 _Sign3position;
			float _Sign1size;
			float _Sign2size;
			float _Sign3size;
						...
						)
			{
				...
				float2 texCoord33 = packedInput.ase_texcoord5.xy * temp_cast_0 + _Sign1position;
				float4 tex2DNode11 = tex2D( _Sign1, texCoord33 );
				...
				float2 texCoord44 = packedInput.ase_texcoord5.xy * temp_cast_1 + _Sign2position;
				float4 tex2DNode21 = tex2D( _Sing2, texCoord44 );
				...
				float2 texCoord47 = packedInput.ase_texcoord5.xy * temp_cast_2 + _Sign3position;
				float4 tex2DNode20 = tex2D( _Sing3, texCoord47 );
				...
				surfaceDescription.BaseColor = ( tex2D( _Albedo, uv_Albedo ) * lerpResult9 ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 temp_cast_0 = (_Sign1size).xx;
				float2 texCoord33 = packedInput.ase_texcoord2.xy * temp_cast_0 + _Sign1position;
				float4 tex2DNode11 = tex2D( _Sign1, texCoord33 );
				#ifdef _INVERTSIGN1_ON
				float4 staticSwitch51 = tex2DNode11;
				#else
				...
				#endif
				float2 temp_cast_1 = (_Sign2size).xx;
				float2 texCoord44 = packedInput.ase_texcoord2.xy * temp_cast_1 + _Sign2position;
				float4 tex2DNode21 = tex2D( _Sing2, texCoord44 );
				#ifdef _INVERTSIGN2_ON
				float4 staticSwitch52 = tex2DNode21;
				#else
				...
				#endif
				float2 temp_cast_2 = (_Sign3size).xx;
				float2 texCoord47 = packedInput.ase_texcoord2.xy * temp_cast_2 + _Sign3position;
				float4 tex2DNode20 = tex2D( _Sing3, texCoord47 );
				#ifdef _INVERTSIGN3_ON
				float4 staticSwitch53 = tex2DNode20;
				#else
				...
				#endif
				float grayscale16 = (saturate( ( staticSwitch51 + staticSwitch52 + staticSwitch53 ) ).rgb.r + saturate( ( staticSwitch51 + staticSwitch52 + staticSwitch53 ) ).rgb.g + saturate( ( staticSwitch51 + staticSwitch52 + staticSwitch53 ) ).rgb.b) / 3;
				float2 uv_ColorMask = packedInput.ase_texcoord2.xy * _ColorMask_ST.xy + _ColorMask_ST.zw;
				float4 tex2DNode10 = tex2D( _ColorMask, uv_ColorMask );
				#ifdef _INVERTCOLORMASK_ON
				float4 staticSwitch54 = tex2DNode10;
				#else
		...
		Pass
		{
						...
						)
			{
				...
				float2 temp_cast_0 = (_Sign1size).xx;
				float2 texCoord33 = packedInput.ase_texcoord7.xy * temp_cast_0 + _Sign1position;
				float4 tex2DNode11 = tex2D( _Sign1, texCoord33 );
				#ifdef _INVERTSIGN1_ON
				float4 staticSwitch51 = tex2DNode11;
				#else
				...
				#endif
				float2 temp_cast_1 = (_Sign2size).xx;
				float2 texCoord44 = packedInput.ase_texcoord7.xy * temp_cast_1 + _Sign2position;
				float4 tex2DNode21 = tex2D( _Sing2, texCoord44 );
				#ifdef _INVERTSIGN2_ON
				float4 staticSwitch52 = tex2DNode21;
				#else
				...
				#endif
				float2 temp_cast_2 = (_Sign3size).xx;
				float2 texCoord47 = packedInput.ase_texcoord7.xy * temp_cast_2 + _Sign3position;
				float4 tex2DNode20 = tex2D( _Sing3, texCoord47 );
				#ifdef _INVERTSIGN3_ON
				float4 staticSwitch53 = tex2DNode20;
				#else
...
WireConnection;56;4;3;1
WireConnection;56;7;3;4
WireConnection;56;8;3;2
ASEEND*/
//CHKSM=288E5296E02C6486254354EC1A1B49674A64E689